DROP TABLE IF EXISTS folio_reporting.agreements_subscription_agreement_entitlement;
...
CREATE INDEX ON folio_reporting.agreements_subscription_agreement_entitlement (entitlement_active_to);

CREATE INDEX ON folio_reporting.agreements_subscription_agreement_entitlement (entitlement_active_from);

CREATE INDEX ON folio_reporting.agreements_subscription_agreement_entitlement (entitlement_subscription_agreement_id);

CREATE INDEX ON folio_reporting.agreements_subscription_agreement_entitlement (entitlement_resource_fk);

CREATE INDEX ON folio_reporting.agreements_subscription_agreement_entitlement (entitlement_authority);

CREATE INDEX ON folio_reporting.agreements_subscription_agreement_entitlement (entitlement_reference);

CREATE INDEX ON folio_reporting.agreements_subscription_agreement_entitlement (po_line_id);
