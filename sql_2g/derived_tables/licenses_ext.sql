DROP TABLE IF EXISTS folio_reporting.licenses_ext;
...
CREATE TABLE folio_reporting.licenses_ext AS
SELECT
...
CREATE INDEX ON folio_reporting.licenses_ext (license_id);

CREATE INDEX ON folio_reporting.licenses_ext (license_name);

CREATE INDEX ON folio_reporting.licenses_ext (license_description);

CREATE INDEX ON folio_reporting.licenses_ext (license_start);

CREATE INDEX ON folio_reporting.licenses_ext (license_end);

CREATE INDEX ON folio_reporting.licenses_ext (license_type);

CREATE INDEX ON folio_reporting.licenses_ext (license_status);

CREATE INDEX ON folio_reporting.licenses_ext (license_org);

CREATE INDEX ON folio_reporting.licenses_ext (license_org_role);

CREATE INDEX ON folio_reporting.licenses_ext (license_org_uuid);
