...
CREATE INDEX ON loans_items (item_effective_call_number);

CREATE INDEX ON loans_items (item_effective_call_number_prefix);

CREATE INDEX ON loans_items (item_effective_call_number_suffix);
