...
SELECT
    ...
    json_extract_path_text(INSTANCE.DATA, 'discovery_suppress')::boolean AS discovery_suppress,
    json_extract_path_text(INSTANCE.DATA, 'staff_suppress')::boolean AS staff_suppress,
