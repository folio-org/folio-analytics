...
CREATE INDEX ON local.instance_electronic_access (instance_id);

CREATE INDEX ON local.instance_electronic_access (instance_hrid);

CREATE INDEX ON local.instance_electronic_access (link_text);

CREATE INDEX ON local.instance_electronic_access (materials_specification);

CREATE INDEX ON local.instance_electronic_access (public_note);

CREATE INDEX ON local.instance_electronic_access (relationship_id);

CREATE INDEX ON local.instance_electronic_access (relationship_name);

CREATE INDEX ON local.instance_electronic_access (uri);
