...
FROM
    ...
    LEFT JOIN inventory_call_number_types AS effective_call_number_type ON (items.data #>> '{effectiveCallNumberComponents,typeID}')::uuid = effective_call_number_type.id;
