...
CREATE INDEX ON local.po_lines_eresource (location_name);

CREATE INDEX ON local.po_lines_eresource (pol_access_provider);

CREATE INDEX ON local.po_lines_eresource (provider_org_name);

CREATE INDEX ON local.po_lines_eresource (pol_activated);

CREATE INDEX ON local.po_lines_eresource (pol_activation_due);

CREATE INDEX ON local.po_lines_eresource (pol_create_inventory);

CREATE INDEX ON local.po_lines_eresource (pol_expected_activation);

CREATE INDEX ON local.po_lines_eresource (pol_license);

CREATE INDEX ON local.po_lines_eresource (pol_license_desc);

CREATE INDEX ON local.po_lines_eresource (pol_material_type);

CREATE INDEX ON local.po_lines_eresource (pol_er_mat_type_name);

CREATE INDEX ON local.po_lines_eresource (pol_trial);
