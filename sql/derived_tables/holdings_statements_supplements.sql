...
CREATE INDEX ON local.holdings_statements_supplements ("statement");

CREATE INDEX ON local.holdings_statements_supplements (public_note);

CREATE INDEX ON local.holdings_statements_supplements (staff_note);
