...
CREATE INDEX ON local.item_electronic_access (item_id);

CREATE INDEX ON local.item_electronic_access (item_hrid);

CREATE INDEX ON local.item_electronic_access (link_text);

CREATE INDEX ON local.item_electronic_access (materials_specification);

CREATE INDEX ON local.item_electronic_access (public_note);

CREATE INDEX ON local.item_electronic_access (relationship_id);

CREATE INDEX ON local.item_electronic_access (relationship_name);

CREATE INDEX ON local.item_electronic_access (uri);
