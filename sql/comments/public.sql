...
COMMENT ON COLUMN public.user_users.personal__date_of_birth IS 'The users birth date';
COMMENT ON COLUMN public.user_users.personal__email IS 'The users email address';
COMMENT ON COLUMN public.user_users.personal__first_name IS 'The users given name';
COMMENT ON COLUMN public.user_users.personal__last_name IS 'The users surname';
COMMENT ON COLUMN public.user_users.personal__middle_name IS 'The users middle name (if any)';
COMMENT ON COLUMN public.user_users.personal__mobile_phone IS 'The users mobile phone number';
COMMENT ON COLUMN public.user_users.personal__phone IS 'The users primary phone number';
COMMENT ON COLUMN public.user_users.personal__preferred_contact_type_id IS 'ID of users preferred contact type like Email, Mail or Text Message';
COMMENT ON COLUMN public.user_users.personal__preferred_first_name IS 'The users preferred name';
