...
COMMENT ON COLUMN public.circulation_loans.patron_group_id_at_checkout IS 'Patron Group at checkout';
...
COMMENT ON COLUMN public.circulation_loan_history.id IS 'Unique ID (generated UUID) of the snapshot of the loan record';
...
COMMENT ON COLUMN public.circulation_request_preference.id IS 'Unique request preference ID';
...
COMMENT ON COLUMN public.circulation_request_preference.user_id IS 'UUID of user associated with this request preference';
...
COMMENT ON COLUMN public.circulation_request_policies.id IS 'Unique request policy ID';
...
COMMENT ON COLUMN public.circulation_patron_notice_policies.id IS 'Patron notice policy ID, UUID';
...
COMMENT ON COLUMN public.circulation_check_ins.id IS 'Unique ID (generated UUID) of the check-in operation';
COMMENT ON COLUMN public.circulation_check_ins.item_id IS 'ID of item that has been checked in';
COMMENT ON COLUMN public.circulation_check_ins.item_location_id IS 'Location of the item at check-in time';
...
COMMENT ON COLUMN public.circulation_check_ins.performed_by_user_id IS 'ID of user that performed check-in operation';
COMMENT ON COLUMN public.circulation_check_ins.request_queue_size IS 'Request queue size for the item';
COMMENT ON COLUMN public.circulation_check_ins.service_point_id IS 'Service point where the item was checked in';
...
COMMENT ON COLUMN public.circulation_scheduled_notices.id IS 'UUID of scheduled task';
COMMENT ON COLUMN public.circulation_scheduled_notices.loan_id IS 'UUID of related loan for loan notices';
COMMENT ON COLUMN public.circulation_scheduled_notices.next_run_time IS 'Next run time';
COMMENT ON COLUMN public.circulation_scheduled_notices.recipient_user_id IS 'ID of the user to whom this notice should be sent to';
COMMENT ON COLUMN public.circulation_scheduled_notices.request_id IS 'UUID of related request for request notices';
