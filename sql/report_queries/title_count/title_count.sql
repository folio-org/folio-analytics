...
holdings_type_id, holdings_type_name, holdings_callnumber_type_id, holding_scallnumber_type_name, holdings_statistical_code_id, holdings_statistical_code, holdings_statistical_code_name,
...
WITH parameters AS (
    ...
    SELECT
        ...
        ''::VARCHAR AS holdings_callnumber_type_filter, -- select ..... or leave blank for all.
        ''::VARCHAR AS holdings_callnumber_filter, -- use %% as wildcards '1234-abc%%','%%1234-abc','%%1234-abc%%'
        ''::VARCHAR AS holdings_acquisition_method_filter, -- select ..... or leave blank for all.
        -- STATISTICAL CODES
        ...
        ''::VARCHAR AS instance_statistical_code_type_filter, -- select ... or leave blank for all.
        -- LOCATION
...
SELECT
    ...
    hld.call_number_type_name AS holding_scallnumber_type_name,
