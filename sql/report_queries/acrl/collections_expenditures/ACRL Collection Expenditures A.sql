...
SELECT
	...
	pol.id AS pol_id,
    	...
    	coalesce (invadjext.invls_total, 0) ::numeric(12, 2) AS invls_total,-- This is coming from the invoice_adjustments_ext table
    	inv.exchange_rate::NUMERIC(12,3) AS inv_exchange_rate,
