--metadb:table holdings_statements_supplements
...
WITH holdings AS (
    ...
    FROM
        ...
        CROSS JOIN LATERAL jsonb_array_elements(jsonb_extract_path(h.jsonb, 'holdingsStatementsForSupplements')) WITH ORDINALITY AS hs (jsonb)
)
SELECT    
    hs.instance_id,
