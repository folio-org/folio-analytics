...
COMMENT ON COLUMN po_lines_vendor_reference_number.po_line_id IS 'UUID identifying this purchase order line';

COMMENT ON COLUMN po_lines_vendor_reference_number.po_line_number IS 'A human readable number assigned to this PO line';

COMMENT ON COLUMN po_lines_vendor_reference_number.vendor_reference_number IS 'A reference number for this purchase order line';

COMMENT ON COLUMN po_lines_vendor_reference_number.vendor_reference_number_type IS 'The reference number type';

COMMENT ON COLUMN po_lines_vendor_reference_number.vendor_instructions IS 'Special instructions for the vendor';
